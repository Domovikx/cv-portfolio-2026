...
- **Адаптивность обязательна**: при любых UI-правках следуй скилу
  `responsive-ui` (брейкпоинты 480/600/640/768/860/992/1280) и проверяй
  мобильные ширины в DevTools.

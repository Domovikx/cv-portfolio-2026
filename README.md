...
CV-портфолио фронтенд-разработчика **DomovikX** — живой проект, показывающий
стек и подход к работе. Визуальный язык вдохновлён сайтом карьеры Альфа-Банка
(палитра, скругления, анимации) — без брендовых элементов.
